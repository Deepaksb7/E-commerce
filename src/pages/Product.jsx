    ...
    <div className='border-top-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex-col-reverse flex gap-3 sm:flex-row'>
          ...
          <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-auto justify-between sm:justify-normal sm:w-[19.1%] w-full' >
            {
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          ...
          <p>E-commerce websites typically display products or services along with detailed descriptions, images, prices, and any available variations (e.g. sizes, colors). Each product usually has it's own dedicated page with relevant information.</p>
